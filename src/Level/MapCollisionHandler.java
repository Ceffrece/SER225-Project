    ...
    public static MapCollisionCheckResult getAdjustedPositionAfterCollisionCheckX(GameObject gameObject, Map map, Direction direction) {
        ...
        for (Enemy enemy : map.getActiveEnemies()) {
            if (!gameObject.equals(enemy) && (!enemy.isUncollidable() || !(gameObject instanceof Player)) && hasCollidedWithMapEntity(gameObject, enemy, direction)) {
                ...
                if (direction == Direction.RIGHT) {
                    float boundsDifference = gameObject.getX2() - gameObject.getBoundsX2();
                    adjustedPositionX = enemy.getBoundsX1() - gameObject.getWidth() + boundsDifference;
                } else if (direction == Direction.LEFT) {
                    float boundsDifference = gameObject.getBoundsX1() - gameObject.getX();
                    adjustedPositionX = (enemy.getBoundsX2() + 1) - boundsDifference;
                }
                return new MapCollisionCheckResult(new Point(adjustedPositionX, gameObject.getY()), entityCollidedWith);
            }
        }
        for (Boss boss : map.getActiveBosses()) {
            if (!gameObject.equals(boss) && !boss.isUncollidable() && hasCollidedWithMapEntity(gameObject, boss, direction)) {
                entityCollidedWith = boss;
                float adjustedPositionX = gameObject.getX();
                if (direction == Direction.RIGHT) {
                    float boundsDifference = gameObject.getX2() - gameObject.getBoundsX2();
                    adjustedPositionX = boss.getBoundsX1() - gameObject.getWidth() + boundsDifference;
                } else if (direction == Direction.LEFT) {
                    float boundsDifference = gameObject.getBoundsX1() - gameObject.getX();
                    adjustedPositionX = (boss.getBoundsX2() + 1) - boundsDifference;
                }
                return new MapCollisionCheckResult(new Point(adjustedPositionX, gameObject.getY()), entityCollidedWith);
            }
        }
        for (Pickup pickup : map.getActivePickups()) {
            if(!gameObject.equals(pickup) && !pickup.isUncollidable() && hasCollidedWithMapEntity(gameObject, pickup, direction)) {
                entityCollidedWith = pickup;
                float adjustedPositionX = gameObject.getX();
                if (direction == Direction.RIGHT) {
                    float boundsDifference = gameObject.getX2() - gameObject.getBoundsX2();
                    adjustedPositionX = pickup.getBoundsX1() - gameObject.getWidth() + boundsDifference;
                } else if (direction == Direction.LEFT) {
                    float boundsDifference = gameObject.getBoundsX1() - gameObject.getX();
                    adjustedPositionX = (pickup.getBoundsX2() + 1) - boundsDifference;
                }
                return new MapCollisionCheckResult(new Point(adjustedPositionX, gameObject.getY()), entityCollidedWith);
            }
        }
    ...
    public static MapCollisionCheckResult getAdjustedPositionAfterCollisionCheckY(GameObject gameObject, Map map, Direction direction) {
        ...
        for (Enemy enemy : map.getActiveEnemies()) {
            if (!gameObject.equals(enemy) && !enemy.isUncollidable() && hasCollidedWithMapEntity(gameObject, enemy, direction)) {
                ...
                if (direction == Direction.DOWN) {
                    float boundsDifference = gameObject.getY2() - gameObject.getBoundsY2();
                    adjustedPositionY = enemy.getBoundsY1() - gameObject.getHeight() + boundsDifference;
                } else if (direction == Direction.UP) {
                    float boundsDifference = gameObject.getBoundsY1() - gameObject.getY();
                    adjustedPositionY = (enemy.getBoundsY2() + 1) - boundsDifference;
                }
                return new MapCollisionCheckResult(new Point(gameObject.getX(), adjustedPositionY), entityCollidedWith);
            }
        }
        for (Pickup pickup : map.getActivePickups()) {
            if (!gameObject.equals(pickup) && !pickup.isUncollidable() && hasCollidedWithMapEntity(gameObject, pickup, direction)) {
                ...
                if (direction == Direction.DOWN) {
                    float boundsDifference = gameObject.getY2() - gameObject.getBoundsY2();
                    adjustedPositionY = pickup.getBoundsY1() - gameObject.getHeight() + boundsDifference;
                } else if (direction == Direction.UP) {
                    float boundsDifference = gameObject.getBoundsY1() - gameObject.getY();
                    adjustedPositionY = (pickup.getBoundsY2() + 1) - boundsDifference;
                }
                return new MapCollisionCheckResult(new Point(gameObject.getX(), adjustedPositionY), entityCollidedWith);
            }
        }
