...
public class Camera extends Rectangle {
    ...
    private ArrayList<EnemyProjectile> activeEnemyProjectiles = new ArrayList<>();
    ...
    // determine which enemy projectiles are active (exist and are within range of the camera)
