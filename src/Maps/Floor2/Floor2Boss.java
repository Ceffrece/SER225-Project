...
public class Floor2Boss extends Map {
    ...
    public Floor2Boss() {
        ...
        public ArrayList<Boss> loadBosses() {
            ...
            boss2 = new Boss(getMapTile(7,6).getLocation(), new SpriteSheet(ImageLoader.load("EnemySprites/ColdStone.png"), 100, 40), "DEFAULT", 100, 2);
            bosses.add(boss2);
    ...
    public void loadScripts() {
        ...
        getMapTile(12,2).setInteractScript(new RandomChangeMapScript(3));
    }
