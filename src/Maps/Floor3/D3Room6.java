...
public class D3Room6 extends Map {
    ...
    public D3Room6() {
        ...
        public ArrayList<Enemy> loadEnemies() {
            ...
            ParmesanProwler spineapple1 = new ParmesanProwler(0, getMapTile(2, 17).getLocation());
            spineapple1.setExistenceFlag("hasTalkedToSpineapple");
            enemies.add(spineapple1);

            ParmesanProwler spineapple2 = new ParmesanProwler(0, getMapTile(25, 2).getLocation());
            spineapple2.setExistenceFlag("hasTalkedToSpineapple");
            enemies.add(spineapple2);

            ParmesanProwler spineapple3 = new ParmesanProwler(0, getMapTile(24, 17).getLocation());
