...
// Class for the tileset meant for floor 3 (milk/cheese/dairy themed)
// Each room will be its own map so this is gonna get called quite a few times
public class Floor3Tileset extends Tileset {
    
    public Floor3Tileset() {
        super(ImageLoader.load("tilesets//Floor3Tileset.png"), 16, 16, 3);
    }
