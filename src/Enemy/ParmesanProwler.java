...
// This class is for the Parmesan Prowler Enemy
public class ParmesanProwler extends Enemy
{
        protected int health;

      
        public ParmesanProwler(int id, Point location) 
        {
                super(id, location.x, location.y, new SpriteSheet(ImageLoader.load("EnemySprites/ParmesanProwler.png"), 32, 32), "STAND_LEFT");
