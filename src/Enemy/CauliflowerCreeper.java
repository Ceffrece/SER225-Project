...
// This class is for the Cauliflower Creeper Enemy
public class CauliflowerCreeper extends Enemy
{
        protected int health;

      
        public CauliflowerCreeper(int id, Point location) 
        {
                super(id, location.x, location.y, new SpriteSheet(ImageLoader.load("EnemySprites/CauliflowerCreeper.png"), 32, 32), "STAND_LEFT");
