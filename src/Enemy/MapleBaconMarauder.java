...
// This class is for the Maple Bacon Marauder Enemy
public class MapleBaconMarauder extends Enemy
{
        protected int health;

      
        public MapleBaconMarauder(int id, Point location) 
        {
                super(id, location.x, location.y, new SpriteSheet(ImageLoader.load("EnemySprites/MapleBaconMarauder.png"), 32, 32), "STAND_LEFT");
