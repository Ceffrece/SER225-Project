...
// This class is for the Eggplant Artillery Enemy
public class EggplantArtillery extends Enemy
{
        protected int health;

      
        public EggplantArtillery(int id, Point location) 
        {
                super(id, location.x, location.y, new SpriteSheet(ImageLoader.load("EnemySprites/EggplantArtillery.png"), 32, 32), "STAND_LEFT");
